...
(function() {
  var NUM_CHANNELS, SAMPLE_RATE, appendFile, appendSilence, argv, async, child_process, exportFile, exportFileCaf, files, fs, json, makeRawAudioFile, mktemp, offsetCursor, optimist, os, pad, path, processFiles, spawn, tempFile, util, wavArgs, winston, _;
