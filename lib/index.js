...
(function() {
  var appendFile, appendSilence, argv, async, child_process, exportFile, exportFileCaf, files, fs, mktemp, numChannels, optimist, path, spawn, tempFile, wavArgs, winston, _,
    __slice = [].slice;
