...
(function() {
  var NUM_CHANNELS, SAMPLE_RATE, appendFile, appendSilence, argv, async, child_process, exportFile, exportFileCaf, files, fs, json, mktemp, offsetCursor, optimist, path, processFiles, spawn, tempFile, wavArgs, winston, _,
    __slice = [].slice;
